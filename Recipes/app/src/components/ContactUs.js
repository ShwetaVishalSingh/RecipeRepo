            ...
            <div className="footer-box pad-top-70">
                            ...
                            <div className="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div className="footer-box-a">
                                    ...
                                    <ul className="socials-box footer-socials pull-left">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div className="social-circle-border"><i className="fa fa-twitter"></i>
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div className="social-circle-border"><i className="fa fa-linkedin"></i>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div id="copyright" className="copyright-main">
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <h6 className="copy-title"> Copyright &copy; 2017 Food Funday is powered by <a href="#"
                                                                                                               target="_blank"></a>
                                </h6>
                            </div>
                        </div>
