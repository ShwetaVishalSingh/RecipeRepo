    ...
    const postData = () => {
        fetch('/api/user/register', {
            ...
            if (response.status === 200) {
                ...
                props.history.push("/");
                showNotification("Error!", "Hello Vishal! User are registered successfully.", "success");
            } else {
                showNotification("User Registered!", "Seems like you are missing some required details or you are not providing valid details.", "danger");
            }
        })
    };
